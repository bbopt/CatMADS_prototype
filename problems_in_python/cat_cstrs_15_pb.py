...
def cat_cstrs_15(X):
    """
    Cat-cstrs-15 based on the Toy problem from
        M. Munoz Zuniga and D. Sinoquet. Global optimization for mixed categorical-continuous variables based
        on Gaussian process models with a randomized categorical space exploration step. INFOR: Information
        Systems and Operational Research, 58(2):310–341, 2020

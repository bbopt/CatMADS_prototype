...
def cat_cstrs_12(X):
    """
    Cat-cstrs-12 based on the Reinforced Concrete Beam design problem from
        A.-S. Crélot, C. Beauthier, D. Orban, C. Sainvitu, and A. Sartenaer. Combining Surrogate Strategies
        with MADS for Mixed-Variable Derivative-Free Optimization. Technical Report G-2017-70, Les cahiers
        du GERAD, 2017

...
/// Stop type for all QP solver model optimization
enum class QPStopType : int
{
    STARTED                  ,  ///< Started
    CONVERGED                ,  ///< Optimization converged properly
    FAILED                   ,  ///< Optimization has failed
    STAGNATION_ITERATES      ,  ///< Optimization stagnation in iterates,

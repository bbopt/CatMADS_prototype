...
bool NOMAD::DMultiMadsNMSearchMethod::runDoMStrategy()
{
    ...
    NOMAD::NMSearchMethod::runImp(); // TODO successSingleNM ?
...
bool NOMAD::DMultiMadsNMSearchMethod::runMultiMadsStrategy()
{
    ...
    NOMAD::NMSearchMethod::runImp(); // TODO use successSingleNM
...
{
    // TODO maybe something needs to be done here
    throw NOMAD::Exception(__FILE__, __LINE__, "Not yet implemented");


//    // Check if simplex can be created.
...
//
//   const auto dmultimadsIteration = getParentOfType<DMultiMadsIteration*>();
//

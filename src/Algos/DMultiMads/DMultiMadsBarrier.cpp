                                    ...
                                    bool barrierInitializedFromCache)
{
    ...
    // TODO: maybe take into account _xFilterInf points ?
...
// TODO. For now, we keep the function, but we could consider derive DMultiMadsBarrier for Barrier (instead of BaseBarrier). We could remove the BaseBarrier class.
...
void NOMAD::DMultiMadsBarrier::updateXInfAndFilterInfAfterHMaxSet()
{
    ...
    // TODO: for the moment, no test according to the EvalType and ComputeType.
    size_t currentInd = 0;

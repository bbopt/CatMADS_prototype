#ifndef __NOMAD_4_5_QR2NPOLLMETHOD__
#define __NOMAD_4_5_QR2NPOLLMETHOD__

#include "../../Algos/Mads/PollMethodBase.hpp"
#include "../../nomad_nsbegin.hpp"

/// Class to perform QR 2N Poll.
class QR2NPollMethod final : public PollMethodBase
{
public:
    /// Constructor
    /**
     ...
     */
    explicit QR2NPollMethod(const Step* parentStep,
...
private:
    ...
    /**
     Test if the QR2N Poll is enabled or not.
     */
    void init();
    ...
    /**
     ...
     - This direction is transformed into 2n directions using QR decomposition.
...
#endif // __NOMAD_4_5_QR2NPOLLMETHOD__

...
void NOMAD::QuadModelOptimize::setupRunParameters()
{
    ...
    // TODO: ChT. Check if performance is better with ORTHO_2N for secondary poll instead of DOUBLE
    // _optRunParams->setAttributeValue("DIRECTION_TYPE_SECONDARY_POLL",NOMAD::DirectionType::ORTHO_2N);

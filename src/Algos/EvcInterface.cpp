...
// ChT. Comment to leave a trace for PSD-Mads debugging.
// Put a critical region here. I don't think it is needed as we still have exception due
// incompatible fixed variable.
// It looks like a point from another main thread was added. Don't know how!
#ifdef _OPENMP
#pragma omp critical
#endif
    {

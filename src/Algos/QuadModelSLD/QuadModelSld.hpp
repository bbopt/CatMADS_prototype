 ...
 */
#ifndef __NOMAD_4_5_QUAD_MODEL_SLD__
#define __NOMAD_4_5_QUAD_MODEL_SLD__
...
private:
    ...
    ( const std::vector<Point      *> & l ,
     const std::vector<EvalPoint> & Y   ) const;
...
public:
    ...
    void setY(const std::vector<EvalPoint> & evalPoints)
    {

#ifndef __NOMAD_4_5_QUAD_MODEL_SLD_MEGAITERATION__
#define __NOMAD_4_5_QUAD_MODEL_SLD_MEGAITERATION__
...
/**
 ...
 - End: Post-processing
*/
class QuadModelSldMegaIteration: public MegaIteration
{
private:
    std::vector<std::shared_ptr<QuadModelSldIteration>> _iterList;
...
public:
     ...
     */
    explicit QuadModelSldMegaIteration(const Step* parentStep,
                              size_t k,
    ...
    virtual ~QuadModelSldMegaIteration();
 ...
 */
std::ostream& operator<<(std::ostream& os, const QuadModelSldMegaIteration& megaIteration);

/// Get an MegaIteration values from a stream
std::istream& operator>>(std::istream& is, QuadModelSldMegaIteration& megaIteration);

#include "../../nomad_nsend.hpp"

#endif // __NOMAD_4_5_QUAD_MODEL_SLD_MEGAITERATION__

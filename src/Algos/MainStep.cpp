...
void NOMAD::MainStep::startImp()
{
    ...
    bool doMadsLogBarrier = _allParams->getRunParams()->getAttributeValue<bool>("MADSLOGBARRIER_OPTIMIZATION");
    bool doMadsExteriorPenalty = _allParams->getRunParams()->getAttributeValue<bool>("MADSEXTERIORPENALTY_OPTIMIZATION");
    ...
    {
        // TODO: have a dedicated DMultiMads stop reason if necessary
    ...
    else if (doMadsLogBarrier || doMadsExteriorPenalty)
    {
        auto madsLogBarrierStopReasons = std::make_shared<NOMAD::AlgoStopReasons<NOMAD::MadsStopType>>();
        auto madsLogBarrierAlgo = std::make_shared<NOMAD::MadsLogBarrier>(this,
                                                                  madsLogBarrierStopReasons,
                                                                  _allParams->getRunParams(),
                                                                  _allParams->getPbParams());
        _algos.push_back(madsLogBarrierAlgo);
    }
    else
    {
...
void NOMAD::MainStep::resetComponentsBetweenOptimization()
{
    ...
    // TODO should we reset static functions defined for callbacks (see Mads, Step,....)

                                               ...
                                               const bool updateIncumbentsAndHmax )
{
    ...
    // Detect if there has been a revelation (so the iteration is revealing) // TODO: would be nice to use flag of mega iteration (_isRevealing) to avoid useless cache search, but can't access megaIter from here
